...
<div id="wrap_room">
    ...
    <div id="wrap_room_list">
        <ul class="room_list">
            <li class="list" v-for="room in roomLists" v-bind:key="room.Id">
    ...
    <!-- <div class="select_thema">
        <a v-on:click="chageThema('purpleThema');"><div>테마1</div></a>
        <a v-on:click="chageThema('blueThema');"><div>테마1</div></a>
        <a v-on:click="chageThema('blackThema');"><div>테마1</div></a>
    </div> -->
</div>  
</template>
...
export default {
    ...
    methods: {
        ...
        chageThema: function(themaType) {
            console.log(this.propThema);
            
            console.log('select_thema');
            this.propThema = themaType;
            this.$emit('parentChageThema', this.propThema);
        }
    },
    mounted() {
